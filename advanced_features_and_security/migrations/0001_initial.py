# Generated by Django 5.2.4 on 2025-09-09 16:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='advanced_features_and_security.author')),
                ('genre', models.ManyToManyField(help_text='Select a genre for this book', to='advanced_features_and_security.genre')),
                ('language', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='advanced_features_and_security.language')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='advanced_features_and_security.book')),
